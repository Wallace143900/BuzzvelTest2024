            ...
            <div className={styles.container}>
                ...
                <article>
                    <div className={styles.information}>
                        ...
                        <p className="mobileParagraphySmall" id={styles.p}>Id quis lectus pharetra, ultricies integer montes, amet, gravida consectetur. Nunc convallis fringilla nisl magna sagittis.</p>
                    </div>
                    <div className={styles.information}>
                        <p className="mobileParagraphyStrong" id={styles.pBig}>Ullamcorper arcu</p>
                        <p className="mobileParagraphySmall" id={styles.p}>Ipsum at id hendrerit amet faucibus commodo quam nullam. Lectus auctor habitant duis dictum.</p>
                    </div>
                    <div className={styles.information}>
                        <p className="mobileParagraphyStrong" id={styles.pBig}>Et pellentesque</p>
                        <p className="mobileParagraphySmall" id={styles.p} >Mi vitae, massa eu molestie massa euismod volutpat condimentum. Blandit molestie ullamcorper hendrerit purus lorem vulputate.</p>
                    </div>
                    <div className={styles.information}>
                        <p className="mobileParagraphyStrong" id={styles.pBig}>Amet egestas</p>
                        <p className="mobileParagraphySmall" id={styles.p}>Elementum, libero, lacus, vel ullamcorper at velit id. Malesuada velit et, ullamcorper malesuada amet, felis. </p>
                    </div>
                </article>
            </div>
